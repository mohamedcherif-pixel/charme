...
${theme.class} .quality-option input[type="radio"]:checked + .quality-label .quality-ornament {
    border-color: ${theme.color1} !important;
    box-shadow: none !important;
}

${theme.class} .quality-option[data-quality="top"] input[type="radio"]:checked + .quality-label .quality-ornament {
    border-color: ${theme.color2} !important;
    box-shadow: none !important;
}

${theme.class} .quality-glow {
