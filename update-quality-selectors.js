...
const themesToUpdate = {
    'haltane': themes['haltane'],
    'pegasus': themes['pegasus']
};

for (const [name, theme] of Object.entries(themesToUpdate)) {
    const css = `

/* Quality Selector Theme Overrides */
${theme.class} .quality-badge:hover {
    border-color: rgba(${theme.rgb1}, 0.3) !important;
    background: rgba(${theme.rgb1}, 0.05) !important;
}

${theme.class} .quality-option input[type="radio"]:checked + .quality-label .quality-badge {
    border-color: rgba(${theme.rgb1}, 0.5) !important;
    background: rgba(${theme.rgb1}, 0.08) !important;
    box-shadow: none !important; /* Removed glow */
}

${theme.class} .quality-option[data-quality="top"] input[type="radio"]:checked + .quality-label .quality-badge {
    border-color: rgba(${theme.rgb2}, 0.5) !important;
    background: rgba(${theme.rgb2}, 0.08) !important;
    box-shadow: none !important; /* Removed glow */
}

${theme.class} .quality-option input[type="radio"]:checked + .quality-label .quality-name,
${theme.class} .quality-option input[type="radio"]:checked + .quality-label .quality-description {
    color: ${theme.color1} !important;
}

${theme.class} .quality-option[data-quality="top"] input[type="radio"]:checked + .quality-label .quality-name,
${theme.class} .quality-option[data-quality="top"] input[type="radio"]:checked + .quality-label .quality-description {
    color: ${theme.color2} !important;
}

${theme.class} .quality-option input[type="radio"]:checked + .quality-label .quality-radio {
    border-color: ${theme.color1} !important;
}

${theme.class} .quality-option[data-quality="top"] input[type="radio"]:checked + .quality-label .quality-radio {
    border-color: ${theme.color2} !important;
}

${theme.class} .quality-radio::after {
    background: ${theme.color1} !important;
}

${theme.class} .quality-option[data-quality="top"] .quality-radio::after {
